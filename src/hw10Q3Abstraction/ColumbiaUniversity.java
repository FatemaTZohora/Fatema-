...
// This is a default Constructor
	...
	/*
	 * There are two keywords "extends" and "implements" are used for the inheritance in Java for Regular
	 * Class. Yes, a Regular Class can inherit only one Abstract Class or a regular
	 * class by extends keyword. A Regular class can also inherit more than one Interface by
	 * "implements" keyword. 
	 */
}
