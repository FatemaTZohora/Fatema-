...
public class MyCar {
	...
	public static void main(String[] args) {
		...
		System.out.print(
				"\n\tThe model name of my car is Toyota RAV4 2020.\nIt’s gray color. It is a popular compact SUV with room for five people. \n\tIt was redesigned last year and offers a choice of gas or hybrid drivetrains.It has Front-wheel drive available. \n\tThe 2020 RAV4 uses a 203-hp 2.5-liter four-cylinder engine paired with an eight-speed automatic transmission.");
