...
public class AnimalTest {
	public static void main(String[] args) {
		...
		// "Cobra extends Snake" --This is single Inheritance.
		// "Cobra extends Snake, Snake extends Reptile, Reptile extends Animal"-- they
		// are called Multi-level Inheritance.
		// Cobra extends Animal, Snake extends Animal, Reptile extends Animal"-- they
		...
		// "Robin extends Birds" --This is single Inheritance.
		// "Robin extends Birds, Birds extends Animal"-- they are called Multi-level
		// Inheritance.
		// "Robin extends Animal, Birds extends Animal"-- they are called Hierarchical
		// Inheritance.
		System.out.println("\n----------------------------------------------------\n");
		Dog dog = new Dog();
		dog.dogInfo();
